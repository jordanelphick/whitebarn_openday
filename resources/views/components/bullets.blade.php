<nav class="flex items-center justify-center" aria-label="Progress">
    ...
    <ol role="list" class="ml-8 flex items-center space-x-5">
        <li>
            <!-- Completed Step -->
            <a href="#" class="block h-2.5 w-2.5 rounded-full bg-green-600 hover:bg-green-900">
        ...
        <span class="absolute flex h-5 w-5 p-px" aria-hidden="true">
          <span class="h-full w-full rounded-full bg-green-200"></span>
                ...
                <span class="relative block h-2.5 w-2.5 rounded-full bg-green-600" aria-hidden="true"></span>
