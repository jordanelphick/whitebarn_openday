                        ...
                        <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6">
                            <div>
                                <div class="mt-3 text-center sm:mt-5">
                                    <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">{{ ($selectedRfi->id?'Edit':'New') }} RFI</h3>
                                </div>
                                ...
                                <div class="mt-3 text-left sm:mt-5">
                                    <div class="mt-2">
                                        <label for="quickEditRfi-number" class="block text-sm font-medium leading-6 text-gray-900">RFI Number</label>
                                        <div class="mt-2">
                                            <input wire:model="rfiNumber" disabled type="text" name="quickEditRfi-number" id="quickEditRfi-number" autocomplete="quickEditWorkarea-number" value="{{ $project->acronym .'-'. auth()->user()->organisations->first()->acronym . '-RFI-' . str_pad(App\Models\Rfi::where('organisation_sender', 1)->first()->id +1, 4, '0', STR_PAD_LEFT) }}" class="cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                ...
                                <div class="mt-3 text-left sm:mt-5">
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-3">
                                            <select wire:model="selectOptionWorkpackageId" id="selectWorkpackage-name" autocomplete="selectWorkpackage-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                                ...
                                <div class="mt-3 text-left sm:mt-5">
                                    <div class="col-span-full">
                                        <label for="selectOrganisationReceiver-name" class="block text-sm font-medium leading-6 text-gray-900">For Action</label>
                                        <div class="mt-3">
                                            <select wire:model="selectOptionOrganisationReceiverId" id="selectOrganisationReceiver-name" autocomplete="selectOrganisationReceiver-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                                                @foreach(App\Models\Organisation::orderBy('name','asc')->get() as $organisation)
                                ...
                                <div class="mt-3 text-left sm:mt-5">
                                <div class="col-span-full">
                                    <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">Attachments</label>
